...
def display_results(class_counts, classes_of_interest):
    # Print table header
...
def evaluate(
    preds: dict, gt_path: str, input_CLASS_LABELS: list, input_VALID_CLASS_IDS: list, output_file: str, dataset: str = "scannet", 
):
    global CLASS_LABELS
