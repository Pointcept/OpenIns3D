...
def prepare_data(xyz_rgb, device):
    ...
    points = xyz_rgb[:, :3]
    colors = xyz_rgb[:, 3:] # color is in the range of 0-255
    ...
    return data, features, unique_map, inverse_map
...
if __name__ == '__main__':
    ...
    # prepare data
    data, features, unique_map, inverse_map = prepare_data(mesh, device)
