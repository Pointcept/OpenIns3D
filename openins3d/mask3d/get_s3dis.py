import sys
sys.path.append("/home/zelda/zh340/myzone/test/OpenIns3D/openins3d/mask/mask3d")
...
@hydra.main(config_path="conf", config_name="config_s3dis.yaml")
def get_class_agnostic_masks_s3dis(cfg: DictConfig):
...
def main(cfg: DictConfig):
    get_class_agnostic_masks_s3dis(cfg)
