...
def get_args():
    ...
    parser.add_argument('--dataset', default="s3dis", help='dataset for evaluation, could be s3dis, scannet, stpls3d')
...
def main():
    ...
    evaluate(preds, gt_path, f"./{dataset}_final_result.csv")
